...
<!--        	<div id="spacing_top"></div> -->
            <div id="menu_logo">
                ...
                <div id="conte_menu">
                	<ul id="menu">
						<!--<li><a href="#" id="mLegislacion" onclick="setNameClass(this);">Legislación</a></li> --> <!-- <xsl:value-of select="list-section/home-title" /> -->
                        ...
                        <li><a href="#" id="mLegislacion" onclick="setNameClass(this);">Legislación</a></li>
                        <li><a href="#" id="mJurisprudencia" onclick="setNameClass(this);">Jurisprudencia</a></li> 
                        <li><a href="#" id="mDoctrina" onclick="setNameClass(this);">Doctrina</a></li>
                        <li><a href="#!-- #TEMPLATES:default.htm --#" >Volver</a></li>
            ...
            <form name="ui_form" onsubmit="makeQuery(); return false;" target="_self">
               ...
               <!--     <div class="single_line">
                     ...
                     <div class="single_line" id="moreOptionShow">
	                   <a style="margin:0 5px 0 0;" id="clicki" href="#"> <img style="margin-right: 5px;" src="#!-- #IMAGES:flech.jpg --#" width="7" height="13" border="0" alt="fecha" /> <span style="display:inline; float:none;" id="text_domino">Búsqueda Avanzada  de Legislación</span> <!--<span style="font-size:12px; display: inline; float: none; ">(Llenar al menos un campo)</span>--></a>               
	                   <!--<a id="clickiTN" href="#"> <img src="#!-- #IMAGES:flech.jpg --#" width="7" height="13" border="0" alt="fecha" /> Tipos de Normas</a> -->
                    </div>
                    </div>
                  <!-- TOpis de Normas-->
