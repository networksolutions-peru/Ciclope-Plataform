            ...
            <div style="width: 980px; margin: 0 auto; background-color: #FFF">
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#0D5995">                                                           
                                      
                                      <!-- Add Snipets by Conejo -->
                                      	    <xsl:choose> <!-- Mantiene la seleciona de Legislacion-->
                                                <xsl:when test="list-section/item/home-title='Legislacion'">
                                                <tr style="">   
                                         			 <td style="background-color:#FFF; text-align:center;"><a href="#" style="color:#333; text-decoration:none; font-family:'Trebuchet MS'; font-size:13px; font-weight: bold;" onclick="fnc_filtrar_dominio(this);">Legislacion</a></td>   
                                <td align="center"><a href="#" style="color:#fff; text-decoration:none; font-family:'Trebuchet MS';  font-size:13px; font-weight: bold;" onclick="fnc_filtrar_dominio(this);">Jurisprudencia</a></td> 
                                <td align="center"><a href="#" style="color:#fff; text-decoration:none; font-family:'Trebuchet MS';  font-size:13px; font-weight: bold;" onclick="fnc_filtrar_dominio(this);">Doctrina</a></td>        
  </tr>
                                                </xsl:when><!-- Mantiene la seleciona de JURIPRUDENCIA-->
                                                <xsl:when test="list-section/item/home-title='Jurisprudencia'">
                                                  <tr style="">   
                                         			 <td align="center"><a href="#" style="color:#FFF; text-decoration:none; font-family:'Trebuchet MS'; font-size:13px; font-weight: bold;" onclick="fnc_filtrar_dominio(this);">Legislacion</a></td>   
                                <td style="background-color:#FFF;  text-align:center;"><a href="#" style="color:#333; text-decoration:none; font-family:'Trebuchet MS';  font-size:13px; font-weight: bold;" onclick="fnc_filtrar_dominio(this);">Jurisprudencia</a></td> 
                                <td align="center"><a href="#" style="color:#fff; text-decoration:none; font-family:'Trebuchet MS';  font-size:13px; font-weight: bold;" onclick="fnc_filtrar_dominio(this);">Doctrina</a></td>        
  </tr>
                                                </xsl:when>
                                                <xsl:otherwise><!-- Mantiene la seleciona de DE DOCTRINA-->
                                                 <tr style="">   
                                         			 <td align="center"><a href="#" style="color:#FFF; text-decoration:none; font-family:'Trebuchet MS'; font-size:13px; font-weight: bold;" onclick="fnc_filtrar_dominio(this);">Legislacion</a></td>   
                                <td align="center"><a href="#" style="color:#FFF; text-decoration:none; font-family:'Trebuchet MS';  font-size:13px; font-weight: bold;" onclick="fnc_filtrar_dominio(this);">Jurisprudencia</a></td> 
                                <td style="background-color:#FFF;  text-align:center;"><a href="#" style="color:#333; text-decoration:none; font-family:'Trebuchet MS';  font-size:13px; font-weight: bold;" onclick="fnc_filtrar_dominio(this);">Doctrina</a></td>        
  </tr>
                                                </xsl:otherwise>
                                           </xsl:choose>
                                      <!--End Snipets  -->                 
				...
				<a>
					...
					<xsl:choose>
						...
						<xsl:otherwise> <!-- Legislacion -->
							...
							<xsl:text> - </xsl:text><span style="font-weight:bold;text-decoration:underline;color: #FF0000;font-size: 13px;"><xsl:value-of select="home-title"/></span> 
						</xsl:otherwise>
					</xsl:choose>
				</a>
			</xsl:element>
