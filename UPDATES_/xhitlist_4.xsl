	...
	<xsl:template name="hitlist_navigate_tools">
		<td>
			...
			<select onchange="fnc_hitcount(this)">
				<xsl:variable name="actual_hc" select="list-section/hit-count"/>
				<option value="50" ><xsl:if test="$actual_hc='50'" ><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>50</option>
				<option value="100"><xsl:if test="$actual_hc='100'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>100</option>
				<option value="200"><xsl:if test="$actual_hc='200'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>200</option>
				<option value="300"><xsl:if test="$actual_hc='300'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>300</option>
				<option value="400"><xsl:if test="$actual_hc='400'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>400</option>
				<option value="500"><xsl:if test="$actual_hc='500'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>500</option>
			</select>
				...
				<a>
					...
					<xsl:choose>
						<xsl:when test="home-title='Jurisprudencia'">
							...
							<xsl:text> - </xsl:text><span style="font-weight:bold;text-decoration:underline;color: #FF9F00;font-size: 13px;"><xsl:value-of select="field[@name='tipo_coleccion']"/></span> 
						...
						<xsl:when test="home-title='Doctrina'">
							...
							<xsl:text> - </xsl:text><span style="font-weight:bold;text-decoration:underline;color: #008000;font-size: 13px;"><xsl:value-of select="field[@name='tipo_coleccion']"/></span> 
						...
						<xsl:otherwise> <!-- Legislacion -->
							...
							<xsl:text> - </xsl:text><span style="font-weight:bold;text-decoration:underline;color: #FF0000;font-size: 13px;"><xsl:value-of select="field[@name='tipo_coleccion']"/></span> 
						</xsl:otherwise>
					</xsl:choose>
